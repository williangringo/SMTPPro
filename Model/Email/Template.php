 ...
 * configuration.
 *
 * @author Ashley Schroder (aschroder.com) //Updated by Kevlin, Some Code Credit to WebFlakeStudio
 */
 
class Aschroder_SMTPPro_Model_Email_Template extends Mage_Core_Model_Email_Template {
	
    const XML_PATH_PREFIX = 'system/aschroder_smtppro/';

    public function sendTransactional($templateId, $sender, $email, $name, $vars=array(), $storeId=null)
    {
        if (!Mage::helper('smtppro')->isDisabled($templateId)) {
